<script>
	// IMPORTANT:
	// This component is not written by myself, it's copied
	// As you can easily see, the code is not written in TypeScript
	// and it's hideous. In future somebody should rewrite this
...
<style>
    ...
    .slider.focus .fill {
		background-color: hsla(40, 100%, 55%, 1);
    }
    ...
    .slider .handle.active .nub {
		background-color: hsla(40, 100%, 65%, 1);
    }
